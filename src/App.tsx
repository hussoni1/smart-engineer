      ...
      <div className="lesson-layout">
        ...
        <article className="lesson-content">
          ...
          <div className="lesson-body">
            ...
            {course.slug === "cpp" && <div className="video-lesson"><div className="video-lesson-heading"><span className="eyebrow">شرح بالفيديو</span><strong>دورة C++ مع Programming Advices</strong></div><p>تابع شرح الدكتور محمد أبو هدهود من الكورس الرسمي، ثم ارجع إلى الدرس هنا لحل الأسئلة والتطبيقات.</p><a className="primary-button" href="https://www.youtube.com/@ProgrammingAdvices/courses" target="_blank" rel="noreferrer">فتح كورس C++ على YouTube ↗</a><small>المصدر: <a href="https://www.youtube.com/@ProgrammingAdvices" target="_blank" rel="noreferrer">Programming Advices</a>.</small></div>}
