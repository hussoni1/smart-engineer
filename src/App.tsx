      ...
      <div className="lesson-layout">
        ...
        <article className="lesson-content">
          ...
          <div className="lesson-body">
            ...
            {course.slug === "cpp" && <div className="video-lesson"><div className="video-lesson-heading"><span className="eyebrow">شرح بالفيديو</span><strong>دورة C++ مع Programming Advices</strong></div><div className="video-frame"><iframe src="https://www.youtube.com/embed/DzwcA_sRIss" title="Important Before You Start With C++ Course - Programming Advices" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div><p>شاهد المقدمة الرسمية للدكتور محمد أبو هدهود، ثم تابع بقية دروس الكورس من صفحة القناة وحل الأسئلة هنا.</p><a className="primary-button" href="https://www.youtube.com/@ProgrammingAdvices/courses" target="_blank" rel="noreferrer">فتح بقية كورس C++ ↗</a><small>المصدر: <a href="https://www.youtube.com/@ProgrammingAdvices" target="_blank" rel="noreferrer">Programming Advices</a>.</small></div>}
